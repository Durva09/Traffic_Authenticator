...
import model.MedicalUpdateAuthenticator;


public class EditMedicalServlet extends HttpServlet {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
       ...
       //Setting the values in the MedicalDTO
        ...
        MedicalUpdateAuthenticator med = new MedicalUpdateAuthenticator();
        boolean check = med.editMedicalDetails(dto);
