<%-- 
    Document   : rtoVehicleVerification
    Created on : 18 Apr, 2022, 12:04:25 AM
    Author     : 91934
--%>
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    <form action="RtoVehicleVerificationServlet" method="post">
                                        <input type="text" name="vehicleid" value="<%out.print(vehicle1.getChassis());%>" hidden>
                                        
                                        <button type="submit" class="btn btn-success" value="approve" name="button"> Approve</button>
                                    
                                    
                                        <button type="submit" class="btn btn-danger" value="reject" name="button"> Reject </button>
