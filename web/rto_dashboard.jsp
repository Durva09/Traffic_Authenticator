<%@page import="dto.RtoDTO"%>
<%@page import="dao.RtoDAO"%>
...
<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
  ...
  >
      ...
      <%
       ...
       RtoDTO rtos=rto.getRtoData(userid);
