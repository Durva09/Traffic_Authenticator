    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        <!-- Begin page -->
         <%
          ...
          ArrayList<VehicleDTO> arraylist=vehicle.getCheckedVehicleList();
          %>
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            <center><a href="rtoVehicleDetails.jsp?chassisno=<%=vehicle1.getChassis()%>"> <i class="mdi mdi-eye mdi-24px "></i></a></center>
                                                        </td>
                                                    </tr>
                                                    <% i++; }%>
                                                </tbody>
