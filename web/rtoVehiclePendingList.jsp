    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        <!-- Begin page -->
         <%
          ...
          ArrayList<VehicleDTO> arraylist=vehicle.getPendingVehicleList(userid);
          %>
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
                                            ...
                                            <table class="table table-centered w-100 nowrap overflow-auto" id="products-datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%=vehicle1.getDealerid()%>
                                                        </td>
                    
                                                        <td class="table-action">
                                                            <center><a href="rtoVehicleVerification.jsp?chassisno=<%=vehicle1.getChassis()%>"> <i class="mdi mdi-eye mdi-24px "></i></a></center>
                                                        </td>
                                                    </tr>
                                                    <% i++; }%>
                                                </tbody>
