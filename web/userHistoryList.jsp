                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="javascript:void(0);" class="btn btn-danger mb-2" onclick="location.href='verifyuser.html'"><i class="mdi mdi-plus-circle me-2"></i> Add User</a>
                                            </div>
                                            <div class="col-sm-7">
                                                ...
                                                <tbody>
                                                    <%
                                                            ...
                                                            while(i<dto.size())
                                                            {
                                                                ...
                                                                DocsDTO docs=doc.getUserDocs(dto1.getUserid());
                                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <%=dto1.getUserid()%>
                                                                <br/>
                                                                <input type="hidden" name="user_id" value="<%=dto1.getUserid()%>">
