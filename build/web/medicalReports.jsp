...
{
%>
<form action="DisplayFilesServlet" method="post">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="ps-3 pe-3" action="MedicalReportServlet" method="post" enctype="multipart/form-data">
...
//                            document.getElementById('#warning-alert-modal').style.zIndex="100";
              ...
              <div class="mb-3">
                <label for="password" required class="form-label">Document Title</label>
